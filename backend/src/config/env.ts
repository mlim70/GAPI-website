...
export const SENDER_TX_CONTACT_FORM_CONFIRMATION_ID = process.env.SENDER_TX_CONTACT_FORM_CONFIRMATION_ID;
export const SENDER_TX_MIGRATION_PASSWORD_INVITE_ID = process.env.SENDER_TX_MIGRATION_PASSWORD_INVITE_ID;
