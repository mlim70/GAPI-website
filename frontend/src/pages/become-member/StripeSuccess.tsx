...
export default function StripeSuccess({ setUser }: StripeSuccessProps) {
  ...
  const isFree = search.get('free') === '1';
    ...
    return (
      <div className="min-h-screen flex items-center justify-center py-8 page-background">
        <div className="max-w-md w-full bg-white rounded-lg shadow-lg p-8 text-center">
          ...
          <h1 className="text-2xl font-bold text-gray-900 mb-4">Membership Activated!</h1>
          <p className="text-gray-600 mb-6">
            Your free membership is active. We've sent a confirmation email.
          </p>
          <div className="space-y-4">
            <Link to="/" className="block w-full bg-red hover:bg-red/90 text-white font-semibold py-3 px-6 rounded-lg shadow-lg hover:shadow-xl active:shadow-md transition-all duration-200 cursor-pointer">
              Go to Home
            </Link>
            <Link to="/auth/account" className="block w-full bg-gray-100 hover:bg-gray-200 text-gray-800 font-semibold py-3 px-6 rounded-lg transition-colors duration-200">
              View Account
            </Link>
          </div>
        </div>
