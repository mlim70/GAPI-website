          ...
          <div key={link.label} className="flex items-center">
            {dropdownConfig ? (
              ...
              <NavLink
                ...
                className={({ isActive }) =>
                  [
                    "relative px-0.5 py-1 lg:px-1.5 lg:py-1.5 text-base lg:text-lg font-medium tracking-wide transition-colors whitespace-nowrap",
            ...
            {index < mainLinks.length - 1 && (
              <div className="h-7 w-px bg-neutral-dark/20 mx-2 lg:mx-3"></div>
            )}
          </div>
        );
      })}
